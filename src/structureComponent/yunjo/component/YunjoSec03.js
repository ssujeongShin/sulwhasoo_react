    ...
    <div id="yunjo_sec03">
        <section className="yunjo_essence_info">
            <div className="yunjo_essence_info_flex">
                ...
                <h3 data-aos="fade-up" data-aos-duration="1500" data-aos-anchor-placement="center-bottom">
                60ml&nbsp;&nbsp;<span>105,000원</span>90ml&nbsp;&nbsp;<span>140,000원</span>
                </h3>
                <article>
                <button data-aos="fade-up" data-aos-duration="900" data-aos-delay="100" data-aos-anchor-placement="center-bottom">자세히 보기</button>
                <button data-aos="fade-up" data-aos-duration="900" data-aos-delay="200" data-aos-anchor-placement="center-bottom">구매하러 가기</button>
                </article>
            </div>
        </section>
